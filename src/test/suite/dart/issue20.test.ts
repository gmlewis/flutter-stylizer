...
suite('Issue#20 Tests', function() {
  ...
  test('Issue#20: spurious lines should not be added - ignore enums', () => {
    ...
    runFullStylizer(opts, source, wantSource, [issue20Want[3]])
  })

  test('Issue#20: spurious lines should not be added - with enums', () => {
    const groupAndSortGetterMethods = false
    const processEnumsLikeClasses = true
    const sortOtherMethods = false
    ...
    runFullStylizer(opts, source, wantSource, issue20Want)
  })
})

const issue20Want = [
  [
    EntityType.Unknown,         // line #26: {
    EntityType.LeaveUnmodified, // line #27:   notPublic,
    EntityType.LeaveUnmodified, // line #28:   public,
    EntityType.LeaveUnmodified, // line #29:   nestedPublic,
    EntityType.LeaveUnmodified, // line #30:   nestedPrivate,
    EntityType.LeaveUnmodified, // line #31:   nestedFamily,
    EntityType.LeaveUnmodified, // line #32:   nestedAssembly,
    EntityType.LeaveUnmodified, // line #33:   nestedFamilyAndAssembly,
    EntityType.LeaveUnmodified, // line #34:   nestedFamilyOrAssembly
    EntityType.BlankLine,       // line #35:
  ],
  [
    EntityType.BlankLine, // line #37: { auto, sequential, explicit
  ],
  [
    EntityType.BlankLine, // line #39: { ansi, unicode, auto, custom
  ],
  [
    EntityType.Unknown,  // {
